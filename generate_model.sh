...
wget https://oss.sonatype.org/content/repositories/snapshots/org/kevoree/modeling/org.kevoree.modeling.cpp.generator/1.1-SNAPSHOT/org.kevoree.modeling.cpp.generator-1.1-20131118.133330-1.jar --quiet

echo "Generating Model"
java -jar org.kevoree.modeling.cpp.generator-1.1-20131118.133330-1.jar -i kevoree-core/model/metamodel/kevoree.ecore -t kevoree-core/model
rm -rf kevoree-core/model/META-INF
