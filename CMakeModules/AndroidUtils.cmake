if(NOT ANDROID_PACKAGE_NAME)
  set(ANDROID_PACKAGE_NAME "org.kevoreecpp")
endif()
...
if(ANDROID AND NOT TARGET apk)
    ...
    set(LIBRARY_OUTPUT_PATH_ROOT ${LIBRARY_OUTPUT_PATH})
    set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${LIBRARY_OUTPUT_PATH_ROOT})
    set(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${LIBRARY_OUTPUT_PATH_ROOT}/libs/)
    set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${LIBRARY_OUTPUT_PATH_ROOT})
